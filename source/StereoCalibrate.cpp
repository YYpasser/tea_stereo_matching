...
public:
    ...
    std::vector<StereoPair<cv::Mat>> m_imagesList; /*!< 双目棋盘格图像 */
    std::vector<StereoPair<GoodChessboardImage>> m_goodImagesList; /*!< 优质棋盘格图像 */
    StereoPair<ChessboardCorners> m_corners;  /*!< 棋盘格角点坐标 */
    StereoPair<std::vector<cv::Mat>> m_RVecs; /*!< 相机相对于棋盘格标定板的旋转矩阵 */
    StereoPair<std::vector<cv::Mat>> m_TVecs; /*!< 相机相对于棋盘格标定板的平移矩阵 */
