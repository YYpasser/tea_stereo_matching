...
stereo::CameraIntrinsic::CameraIntrinsic() : intrinsic_matrix(cv::Mat()), distortion_coefficients(cv::Mat())
{
}

stereo::CameraIntrinsic::CameraIntrinsic(const cv::Mat& intrinsic_matrix, const cv::Mat& distortion_coefficients) : intrinsic_matrix(intrinsic_matrix), distortion_coefficients(distortion_coefficients)
{
}

stereo::CameraIntrinsic::CameraIntrinsic(const CameraIntrinsic& other) : intrinsic_matrix(other.intrinsic_matrix), distortion_coefficients(other.distortion_coefficients)
{
}

stereo::CameraIntrinsic::CameraIntrinsic(CameraIntrinsic&& other) noexcept : intrinsic_matrix(std::move(other.intrinsic_matrix)), distortion_coefficients(std::move(other.distortion_coefficients))
{
}

stereo::CameraIntrinsic& stereo::CameraIntrinsic::operator=(const CameraIntrinsic& other)
{
	if (this != &other) {
...
stereo::CameraIntrinsic& stereo::CameraIntrinsic::operator=(CameraIntrinsic&& other) noexcept
{
	if (this != &other) {
...
bool stereo::CameraIntrinsic::empty() const
{
	return this->intrinsic_matrix.empty() || this->distortion_coefficients.empty();
}

stereo::StereoExtrinsic::StereoExtrinsic() : R(cv::Mat()), T(cv::Mat()), E(cv::Mat()), F(cv::Mat())
{
}

stereo::StereoExtrinsic::StereoExtrinsic(const cv::Mat& R, const cv::Mat& T, const cv::Mat& E, const cv::Mat& F) : R(R), T(T), E(E), F(F)
{
}

stereo::StereoExtrinsic::StereoExtrinsic(const StereoExtrinsic& other) : R(other.R), T(other.T), E(other.E), F(other.F)
{
}

stereo::StereoExtrinsic::StereoExtrinsic(StereoExtrinsic&& other) noexcept : R(std::move(other.R)), T(std::move(other.T)), E(std::move(other.E)), F(std::move(other.F))
{
}

stereo::StereoExtrinsic& stereo::StereoExtrinsic::operator=(const StereoExtrinsic& other)
{
	if (this != &other) {
		this->R = other.R;
		this->T = other.T;
...
stereo::StereoExtrinsic& stereo::StereoExtrinsic::operator=(StereoExtrinsic&& other) noexcept
{
	if (this != &other) {
...
bool stereo::StereoExtrinsic::empty() const
{
	return this->R.empty() || this->T.empty() || this->E.empty() || this->F.empty();
}

stereo::EpipolarRectifyMap::EpipolarRectifyMap() : R1(cv::Mat()), R2(cv::Mat()), P1(cv::Mat()), P2(cv::Mat()), map00(cv::Mat()), map01(cv::Mat()), map10(cv::Mat()), map11(cv::Mat())
{
}

stereo::EpipolarRectifyMap::EpipolarRectifyMap(const cv::Mat& R1, const cv::Mat& R2, const cv::Mat& P1, const cv::Mat& P2, const cv::Mat& map00, const cv::Mat& map01, const cv::Mat& map10, const cv::Mat& map11) : R1(R1), R2(R2), P1(P1), P2(P2), map00(map00), map01(map01), map10(map10), map11(map11)
{
}

stereo::EpipolarRectifyMap::EpipolarRectifyMap(const EpipolarRectifyMap& other) : R1(other.R1), R2(other.R2), P1(other.P1), P2(other.P2), map00(other.map00), map01(other.map01), map10(other.map10), map11(other.map11)
{
}

stereo::EpipolarRectifyMap::EpipolarRectifyMap(EpipolarRectifyMap&& other) noexcept : R1(std::move(other.R1)), R2(std::move(other.R2)), P1(std::move(other.P1)), P2(std::move(other.P2)), map00(std::move(other.map00)), map01(std::move(other.map01)), map10(std::move(other.map10)), map11(std::move(other.map11))
{
}

stereo::EpipolarRectifyMap& stereo::EpipolarRectifyMap::operator=(const EpipolarRectifyMap& other)
{
	if (this != &other) {
		R1 = other.R1;
		R2 = other.R2;
...
stereo::EpipolarRectifyMap& stereo::EpipolarRectifyMap::operator=(EpipolarRectifyMap&& other) noexcept
{
	if (this != &other) {
...
void stereo::EpipolarRectifyMap::loadRectifyMapsYMLFile(const std::string& ymlFilePath)
{
	cv::FileStorage fs;
...
void stereo::EpipolarRectifyMap::compute(const StereoPair<CameraIntrinsic>& intrinsic, const cv::Size& imgsz)
{
...
bool stereo::EpipolarRectifyMap::empty() const
{
	return map00.empty() || map01.empty() || map10.empty() || map11.empty();
}

stereo::StereoParams::StereoParams() : intrinsic(StereoPair<CameraIntrinsic>()), extrinsic(StereoExtrinsic()), map(EpipolarRectifyMap()), Q(cv::Mat()), rectified_f(0.f), rectified_cx(0.f), rectified_cy(0.f), baseline(0.f), imgsz(cv::Size())
{
}

stereo::StereoParams::StereoParams(const std::string& ymlFilePath)
{
	loadYAMLFile(ymlFilePath);
}

void stereo::StereoParams::loadYAMLFile(const std::string& ymlFilePath)
{
...
void stereo::ADCensusParams::setADCensusParams(const ColorModel& colorModel)
{
	this->lambdaAD = 10.f;
